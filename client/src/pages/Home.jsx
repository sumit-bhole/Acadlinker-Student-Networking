        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 lg:gap-6">
          ...
          <div className="lg:col-span-6 space-y-6 sm:space-y-8 max-w-[600px] mx-auto w-full pt-8 lg:pt-10">
            ...
            {hasNextPage && (
              <div className="flex justify-center pt-4">
                <button
                  ...
                  className="px-6 py-2.5 bg-white border border-slate-200 text-indigo-600 font-bold rounded-xl shadow-sm hover:bg-indigo-50 hover:border-indigo-200 transition-all flex items-center gap-2"
                >
                  {isFetchingNextPage ? (
            ...
            {!hasNextPage && posts.length > 0 && (
              <p className="text-center text-slate-400 font-medium text-sm pt-4">You're all caught up!</p>
            )}
